...
Example of a build run [from this repository](https://github.com/astahmer/box-extractor-ve-demo) (also available on [StackBlitz](https://stackblitz.com/github/astahmer/box-extractor-ve-demo?file=vite.config.ts)) using `@box-extractor/vanilla-theme` (removed some noise / added space) :
