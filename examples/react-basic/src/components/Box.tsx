...
export const BoxWithCss = <TType extends React.ElementType = typeof defaultElement>({
    children,
    as,
    className,
    style,
    ...props
}: PolymorphicComponentProps<PropsWithChildren<{ css?: BoxProps }>, TType>) => {
    const Component = as ?? defaultElement;
    const boxProps = getBoxProps(props["css"] ?? {}, themeSprinkles);
